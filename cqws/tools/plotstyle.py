...
def load_style():
    ...
    with open(filename, 'w') as f:
        f.write('figure.figsize : 5, 6\n')
        f.write('figure.dpi: 150\n')
        f.write('text.usetex : True\n')
        f.write('axes.labelsize : 13\n')
        f.write('legend.frameon : False\n')
        f.write('xtick.labelsize : 11\n')
        f.write('ytick.labelsize:  11\n')
        f.write('axes.linewidth : 1\n')
        f.write('xtick.minor.visible : True\n')
        f.write('xtick.major.size : 7\n')
        f.write('xtick.minor.size : 3.5\n')
        f.write('xtick.major.width : 1\n')
        f.write('xtick.minor.width : 1\n')
        f.write('xtick.direction : in\n')
        f.write('ytick.minor.visible : True\n')
        f.write('ytick.major.size : 7\n')
        f.write('ytick.minor.size : 3.5\n')
        f.write('ytick.major.width : 1\n')
        f.write('ytick.minor.width : 1\n')
        f.write('ytick.direction : in\n')
        f.write('text.antialiased: True\n')
